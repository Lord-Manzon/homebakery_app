    ...
    const result = await createOrder(
      {
        ...
        delivery_distance_km: orderType === 'delivery' ? distanceKm : null,
        delivery_lat: orderType === 'delivery' ? selectedCoords?.lat ?? null : null,
        delivery_lng: orderType === 'delivery' ? selectedCoords?.lng ?? null : null,
        delivery_date: deliveryDate
          ? deliveryDate.toISOString().split('T')[0]
          : null,
        delivery_time: deliveryTime
          ? deliveryTime.toTimeString().slice(0, 5)
          : null,
      ...
      <View style={styles.section}>
        ...
        <View style={styles.toggleRow}>
          <TouchableOpacity
            style={[
              styles.toggleButton,
              paymentStatus === 'unpaid' && styles.toggleButtonUnpaid,
            ]}
            onPress={() => setPaymentStatus('unpaid')}
          >
            <Text style={[
              styles.toggleText,
              paymentStatus === 'unpaid' && styles.toggleTextActive,
            ]}>
              Unpaid
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[
              styles.toggleButton,
              paymentStatus === 'paid' && styles.toggleButtonPaid,
            ]}
              ...
              <View style={styles.quantityRow}>
                ...
                <View style={styles.quantityControls}>
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      setQuantity((q) =>
                        Math.max(1, parseInt(q) - 1).toString()
                      )
                    }
                  >
